...
export declare type Client = ReturnType<typeof getPrismaClient> extends
	new () => infer T ? T : never;
...
export declare type DynamicModelExtensionOperationFn<
	...
	M extends PropertyKey,
	P extends PropertyKey,
> = {} extends TypeMap["model"][M]["operations"][P]["args"] ? <A>(
...
export declare type DynamicQueryExtensionCbArgsArgs<
	...
	_1 extends PropertyKey,
	_2 extends PropertyKey,
> = _2 extends "$queryRaw" | "$executeRaw" ? Sql
	...
	>(
		extension:
			...
			| {
				...
				client?:
					& DynamicClientExtensionArgs<C_, TypeMap, TypeMapCb, ExtArgs>
					& C;
			},
	): {
...
export declare type GetFindResult<P extends Payload, A> = Equals<A, any> extends
	1 ? DefaultSelection<P> : A extends
	| {
		...
		& {
			[
				...
				: P extends SelectablePayloadFields<K, infer O | null>
					...
					: never
				: K extends "_count" ? Count<GetFindResult<P, (S & I)[K]>>
				: never
				: P extends SelectablePayloadFields<K, (infer O)[]>
					? O extends Payload ? DefaultSelection<O>[] : never
				: P extends SelectablePayloadFields<K, infer O | null>
					? O extends Payload ? DefaultSelection<O> | SelectField<P, K> & null
					: never
				: P extends {
					scalars: {
						[k in K]: infer O;
...
export declare type Path<O, P, Default = never> = O extends unknown
	? P extends [infer K, ...infer R]
		? K extends keyof O ? Path<O[K], R> : Default
	: O
	: never;
...
export declare type RenameAndNestPayloadKeys<P> = {
	[
		K in keyof P as K extends "scalars" | "objects" | "composites" ? keyof P[K]
			: never
	]: P[K];
};
...
declare class RequestHandler {
	...
	handleRequestError(
		{ error, clientMethod, callsite, transaction, args }: HandleErrorParams,
	): never;
