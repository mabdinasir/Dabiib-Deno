...
export namespace Prisma {
  ...
  */
	...
	interface TypeMapCb
		extends
			$Utils.Fn<{ extArgs: $Extensions.Args }, $Utils.Record<string, any>> {
	 ...
	 * HospitalCountOutputType without action
	 */
	export type HospitalCountOutputTypeCountDoctorsArgs<
		ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
	> = {
	 ...
	 * HospitalCountOutputType without action
	 */
	export type HospitalCountOutputTypeCountSchedulesArgs<
		ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
	> = {
	 ...
	 * DoctorCountOutputType without action
	 */
	export type DoctorCountOutputTypeCountHospitalsArgs<
		ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
	> = {
	 ...
	 * DoctorCountOutputType without action
	 */
	export type DoctorCountOutputTypeCountSchedulesArgs<
		ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
	> = {
		where?: ScheduleWhereInput;
	};
	...
	type GetHospitalGroupByPayload<T extends HospitalGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				& PickEnumerable<HospitalGroupByOutputType, T["by"]>
				& {
					[P in ((keyof T) & (keyof HospitalGroupByOutputType))]: P extends
	...
	type HospitalGetPayload<
		S extends boolean | null | undefined | HospitalDefaultArgs,
	> = $Result.GetResult<Prisma.$HospitalPayload, S>;
	...
	> {
		...
		findUnique<T extends HospitalFindUniqueArgs<ExtArgs>>(
			...
			| $Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "findUnique">
			| null,
			null,
			ExtArgs
		>;
		...
		findFirst<T extends HospitalFindFirstArgs<ExtArgs>>(
			...
			| $Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "findFirst">
			| null,
			null,
			ExtArgs
		>;
		...
		findMany<T extends HospitalFindManyArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "findMany">
		>;
		...
		create<T extends HospitalCreateArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "create">,
			never,
			ExtArgs
		>;
		...
		delete<T extends HospitalDeleteArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "delete">,
			never,
			ExtArgs
		>;
		...
		update<T extends HospitalUpdateArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "update">,
			never,
			ExtArgs
		>;
		...
		upsert<T extends HospitalUpsertArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "upsert">,
			never,
			ExtArgs
		>;
		...
		>(
			args:
				& SubsetIntersection<T, HospitalGroupByArgs, OrderByArg>
				& InputErrors,
		): {} extends InputErrors ? GetHospitalGroupByPayload<T>
	...
	> extends Prisma.PrismaPromise<T> {
		...
		doctors<T extends Hospital$doctorsArgs<ExtArgs> = {}>(
			args?: Subset<T, Hospital$doctorsArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "findMany"> | Null
		>;

		schedules<T extends Hospital$schedulesArgs<ExtArgs> = {}>(
			args?: Subset<T, Hospital$schedulesArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "findMany"> | Null
		>;
	...
	type GetDoctorGroupByPayload<T extends DoctorGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				& PickEnumerable<DoctorGroupByOutputType, T["by"]>
				& {
					[P in ((keyof T) & (keyof DoctorGroupByOutputType))]: P extends
						"_count" ? T[P] extends boolean ? number
	...
	type DoctorGetPayload<
		S extends boolean | null | undefined | DoctorDefaultArgs,
	> = $Result.GetResult<Prisma.$DoctorPayload, S>;
	...
	> {
		...
		findUnique<T extends DoctorFindUniqueArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "findUnique"> | null,
			null,
			ExtArgs
		>;
		...
		findUniqueOrThrow<T extends DoctorFindUniqueOrThrowArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "findUniqueOrThrow">,
			never,
			ExtArgs
		>;
		...
		findFirst<T extends DoctorFindFirstArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "findFirst"> | null,
			null,
			ExtArgs
		>;
		...
		findFirstOrThrow<T extends DoctorFindFirstOrThrowArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "findFirstOrThrow">,
			never,
			ExtArgs
		>;
		...
		findMany<T extends DoctorFindManyArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "findMany">
		>;
		...
		create<T extends DoctorCreateArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "create">,
			never,
			ExtArgs
		>;
		...
		delete<T extends DoctorDeleteArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "delete">,
			never,
			ExtArgs
		>;
		...
		update<T extends DoctorUpdateArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "update">,
			never,
			ExtArgs
		>;
		...
		upsert<T extends DoctorUpsertArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$DoctorPayload<ExtArgs>, T, "upsert">,
			never,
			ExtArgs
		>;
		...
		): {} extends InputErrors ? GetDoctorGroupByPayload<T>
			: Prisma.PrismaPromise<InputErrors>;
		/**
	...
	> extends Prisma.PrismaPromise<T> {
		...
		hospitals<T extends Doctor$hospitalsArgs<ExtArgs> = {}>(
			args?: Subset<T, Doctor$hospitalsArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<Prisma.$HospitalPayload<ExtArgs>, T, "findMany"> | Null
		>;

		schedules<T extends Doctor$schedulesArgs<ExtArgs> = {}>(
			args?: Subset<T, Doctor$schedulesArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "findMany"> | Null
		>;
	...
	type GetScheduleGroupByPayload<T extends ScheduleGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				...
				& {
					[P in ((keyof T) & (keyof ScheduleGroupByOutputType))]: P extends
						"_count" ? T[P] extends boolean ? number
	...
	> {
		...
		findUnique<T extends ScheduleFindUniqueArgs<ExtArgs>>(
			...
			| $Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "findUnique">
			| null,
			null,
			ExtArgs
		>;
		...
		findFirst<T extends ScheduleFindFirstArgs<ExtArgs>>(
			...
			| $Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "findFirst">
			| null,
			null,
			ExtArgs
		>;
		...
		findMany<T extends ScheduleFindManyArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "findMany">
		>;
		...
		create<T extends ScheduleCreateArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "create">,
			never,
			ExtArgs
		>;
		...
		delete<T extends ScheduleDeleteArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "delete">,
			never,
			ExtArgs
		>;
		...
		update<T extends ScheduleUpdateArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "update">,
			never,
			ExtArgs
		>;
		...
		upsert<T extends ScheduleUpsertArgs<ExtArgs>>(
			...
			$Result.GetResult<Prisma.$SchedulePayload<ExtArgs>, T, "upsert">,
			never,
			ExtArgs
		>;
		...
		>(
			args:
				& SubsetIntersection<T, ScheduleGroupByArgs, OrderByArg>
				& InputErrors,
		): {} extends InputErrors ? GetScheduleGroupByPayload<T>
			: Prisma.PrismaPromise<InputErrors>;
		/**
	...
	export type ScheduleCreateNestedManyWithoutHospitalInput = {
		create?:
			| XOR<
				ScheduleCreateWithoutHospitalInput,
				ScheduleUncheckedCreateWithoutHospitalInput
			>
			| ScheduleCreateWithoutHospitalInput[]
			| ScheduleUncheckedCreateWithoutHospitalInput[];
		connectOrCreate?:
			| ScheduleCreateOrConnectWithoutHospitalInput
			| ScheduleCreateOrConnectWithoutHospitalInput[];
	...
	export type DoctorUpdateManyWithoutHospitalsNestedInput = {
		...
		connectOrCreate?:
			...
			| DoctorCreateOrConnectWithoutHospitalsInput[];
		upsert?:
			| DoctorUpsertWithWhereUniqueWithoutHospitalsInput
			| DoctorUpsertWithWhereUniqueWithoutHospitalsInput[];
		...
		connect?: DoctorWhereUniqueInput | DoctorWhereUniqueInput[];
		update?:
			| DoctorUpdateWithWhereUniqueWithoutHospitalsInput
			| DoctorUpdateWithWhereUniqueWithoutHospitalsInput[];
		updateMany?:
			| DoctorUpdateManyWithWhereWithoutHospitalsInput
			| DoctorUpdateManyWithWhereWithoutHospitalsInput[];
	...
	export type ScheduleUpdateManyWithoutHospitalNestedInput = {
		...
		connectOrCreate?:
			...
			| ScheduleCreateOrConnectWithoutHospitalInput[];
		upsert?:
			| ScheduleUpsertWithWhereUniqueWithoutHospitalInput
			| ScheduleUpsertWithWhereUniqueWithoutHospitalInput[];
		createMany?: ScheduleCreateManyHospitalInputEnvelope;
		...
		connect?: ScheduleWhereUniqueInput | ScheduleWhereUniqueInput[];
		update?:
			| ScheduleUpdateWithWhereUniqueWithoutHospitalInput
			| ScheduleUpdateWithWhereUniqueWithoutHospitalInput[];
		updateMany?:
			| ScheduleUpdateManyWithWhereWithoutHospitalInput
			| ScheduleUpdateManyWithWhereWithoutHospitalInput[];
	...
	export type ScheduleCreateNestedManyWithoutDoctorInput = {
		create?:
			| XOR<
				ScheduleCreateWithoutDoctorInput,
				ScheduleUncheckedCreateWithoutDoctorInput
			>
			| ScheduleCreateWithoutDoctorInput[]
			| ScheduleUncheckedCreateWithoutDoctorInput[];
		connectOrCreate?:
			| ScheduleCreateOrConnectWithoutDoctorInput
			| ScheduleCreateOrConnectWithoutDoctorInput[];
	...
	export type HospitalUpdateManyWithoutDoctorsNestedInput = {
		...
		update?:
			...
			| HospitalUpdateWithWhereUniqueWithoutDoctorsInput[];
		updateMany?:
			| HospitalUpdateManyWithWhereWithoutDoctorsInput
			| HospitalUpdateManyWithWhereWithoutDoctorsInput[];
	...
	export type ScheduleUpdateManyWithoutDoctorNestedInput = {
		...
		connectOrCreate?:
			...
			| ScheduleCreateOrConnectWithoutDoctorInput[];
		upsert?:
			| ScheduleUpsertWithWhereUniqueWithoutDoctorInput
			| ScheduleUpsertWithWhereUniqueWithoutDoctorInput[];
		createMany?: ScheduleCreateManyDoctorInputEnvelope;
		set?: ScheduleWhereUniqueInput | ScheduleWhereUniqueInput[];
		disconnect?: ScheduleWhereUniqueInput | ScheduleWhereUniqueInput[];
		...
		connect?: ScheduleWhereUniqueInput | ScheduleWhereUniqueInput[];
		update?:
			| ScheduleUpdateWithWhereUniqueWithoutDoctorInput
			| ScheduleUpdateWithWhereUniqueWithoutDoctorInput[];
		updateMany?:
			| ScheduleUpdateManyWithWhereWithoutDoctorInput
			| ScheduleUpdateManyWithWhereWithoutDoctorInput[];
		deleteMany?: ScheduleScalarWhereInput | ScheduleScalarWhereInput[];
	};
	...
	export type DoctorCreateNestedOneWithoutSchedulesInput = {
		create?: XOR<
			DoctorCreateWithoutSchedulesInput,
			DoctorUncheckedCreateWithoutSchedulesInput
		>;
	...
	export type HospitalCreateNestedOneWithoutSchedulesInput = {
		create?: XOR<
			HospitalCreateWithoutSchedulesInput,
			HospitalUncheckedCreateWithoutSchedulesInput
		>;
	...
	export type DoctorUpdateOneRequiredWithoutSchedulesNestedInput = {
		...
		update?: XOR<
			XOR<
				DoctorUpdateToOneWithWhereWithoutSchedulesInput,
				DoctorUpdateWithoutSchedulesInput
			>,
			DoctorUncheckedUpdateWithoutSchedulesInput
		>;
	};
	...
	export type HospitalUpdateOneRequiredWithoutSchedulesNestedInput = {
		...
		update?: XOR<
			XOR<
				HospitalUpdateToOneWithWhereWithoutSchedulesInput,
				HospitalUpdateWithoutSchedulesInput
			>,
			HospitalUncheckedUpdateWithoutSchedulesInput
		>;
	};
	...
	export type DoctorUpdateManyWithWhereWithoutHospitalsInput = {
		...
		data: XOR<
			...
			DoctorUncheckedUpdateManyWithoutHospitalsInput
		>;
	};
	...
	export type ScheduleUpsertWithWhereUniqueWithoutHospitalInput = {
		where: ScheduleWhereUniqueInput;
		update: XOR<
			ScheduleUpdateWithoutHospitalInput,
			ScheduleUncheckedUpdateWithoutHospitalInput
		>;
		create: XOR<
			ScheduleCreateWithoutHospitalInput,
			ScheduleUncheckedCreateWithoutHospitalInput
	...
	export type ScheduleUpdateManyWithWhereWithoutHospitalInput = {
		...
		data: XOR<
			ScheduleUpdateManyMutationInput,
			ScheduleUncheckedUpdateManyWithoutHospitalInput
		>;
	};
	...
	export type HospitalUpdateManyWithWhereWithoutDoctorsInput = {
		...
		data: XOR<
			HospitalUpdateManyMutationInput,
			HospitalUncheckedUpdateManyWithoutDoctorsInput
		>;
	};
	...
	export type ScheduleUpsertWithWhereUniqueWithoutDoctorInput = {
		where: ScheduleWhereUniqueInput;
		update: XOR<
			ScheduleUpdateWithoutDoctorInput,
			ScheduleUncheckedUpdateWithoutDoctorInput
		>;
		create: XOR<
			ScheduleCreateWithoutDoctorInput,
			ScheduleUncheckedCreateWithoutDoctorInput
	...
	export type ScheduleUpdateManyWithWhereWithoutDoctorInput = {
		...
		data: XOR<
			ScheduleUpdateManyMutationInput,
			ScheduleUncheckedUpdateManyWithoutDoctorInput
		>;
	};
